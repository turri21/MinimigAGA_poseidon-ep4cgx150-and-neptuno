...
; set the chips in SetDisplay
	...
	subq.w	#1,d0
	move.w	d2,CardData_VTotal(a0)
	BUG	"VTotal = %ld",d0

	move.w	PSSO_ModeInfo_VerSyncStart(a1),d1
	move.w	d2,CardData_VSStart(a0)
	BUG	"VSStart: %ld",d1
...
;	This might be the best place to do the hardware stuff...
...
ControlWordsByFormat:
	...
	dc.l	ControlWords_invalid	; RGBFB_R5G5B5
...
PixelClocksByFormat:
	...
	dc.l	PixelClocks_invalid	; RGBFB_R5G5B5
